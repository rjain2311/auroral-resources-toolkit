...
/**
 * A dialog that alerts the user to something, with large width
 */
qx.Class.define("dialog.WideAlert",
{
  ...
  members :
  {
    ...
    */     
    ...
    {      
       ...
       * add image 
       */
      this._image = new qx.ui.basic.Image( this.getImage() || "icon/48/actions/help-contents.png" );
